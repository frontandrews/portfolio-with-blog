...
export function ErrorBoundary() {
  ...
  return (
    <html>
      ...
      <body>
        <main className="flex flex-col items-center justify-top min-h-fit lg:min-h-fit bg-white px-8 py-60 lg:py-72">
          <div className="text-center">
            ...
            <p className="mt-6 text-base leading-7 text-gray-600 max-w-sm">
              Sorry, we couldn&apos;t find this page. But don&apos;t worry, checkout the
              <a href="/" className="pl-1 text-blue-300">
                homepage
              </a>
              .
            </p>
