...
export function Records(props: RecordsProps) {
  ...
  return records.length > 0 ? (
    ...
    <div className="prose prose-xl mx-auto bg-green-50 p-4">
      ...
      <p>Or, run </p>
      <pre>
        <code>npx sanity@latest exec ./scripts/createData.ts --with-user-token</code>
      </pre>
      <p>from the command line to delete existing documents populate the site with content. </p>
    </div>
  );
}
